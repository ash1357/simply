...
import SecurityGDPRStyle from '../pages-css/security-gdpr.module.css';
import BasicLayout from '../layout/BasicLayout';
import { window } from 'browser-monads';

const SecurityGDPR = (props) => {
  ...
  return (
    <BasicLayout
      ...
      description="Symply takes your privacy seriously. This privacy policy explains what information we collect, how we use it and what rights you have in relation to it."
    >
      <div className={SecurityGDPRStyle.mainContainer}>
        ...
        <Text fontFamily="Barlow" lg="20px" color="#211E5E" style={{ marginBottom: '45px' }}>
          Thank you for choosing to be part of our community at Symply Software Inc., doing business
          as Symply (“Symply”, “we”, “us”, or “our”). We are committed to protecting your personal
          ...
          <a
            ...
            href="mailto:michael@symply.io"
          >
            <u>michael@symply.io</u>
          </a>
          .
          <br />
          <br />
          When you visit our website https://symply.io/, and use our services, you trust us with
          your personal information. We take your privacy very seriously. In this privacy policy, we
          ...
          through it carefully, as it is important. If there are any terms in this privacy policy
          ...
          in this privacy policy as the "Services"). Please read this privacy policy carefully as it
          will help you make informed decisions about sharing your personal information with us.
        </Text>
        <Text
          fontFamily="Barlow"
          lg="20px"
          color="#4E4E4E"
          style={{ marginBottom: '45px', width: '100%' }}
        >
        ...
        <Text
          ...
          lg="20px"
          color="#4E4E4E"
          style={{ marginBottom: '45px', width: '100%', paddingLeft: '17px' }}
        >
          <ol>
        ...
        >
          <ol>
            ...
            <li>
              ...
              <br />
              <br />
              Publicly Available Personal Information. We collect first name, maiden name, last
              name, and nickname; phone numbers; email addresses; business email; business phone
              number; current and former address; business entity filings, corporate affiliations,
              and business associates; and other similar data.
              <br />
              <br />
              Personal Information Provided by You. We collect taxation, pension, and maternity
              leave; work performance, salary, bonuses, and disciplinary actions; financial
              information (credit card number, purchase history, invoices); passwords; and other
              similar data.
              <br />
              <br />
              ...
              <br />
              <br />
              Online Identifiers. We collect devices; cookie identifiers, or others such as the ones
              used for analytics and marketing; and other similar data.
              <br />
              <br />
            </li>
            ...
            <li>
              ...
              <ul>
                ...
                <li>
                  ...
                  marketing purposes, if this is in accordance with your marketing preferences. You
                ...
                <li>
                  ...
                  display content and advertising (and work with third parties who do so) tailored
                  to your interests and/or location and to measure its effectiveness.
                </li>
                <li>
                  Request Feedback. We may use your information to request feedback and to contact
                ...
                <li>
                  To deliver services to the user. We may use your information to provide you with
            ...
            <li>
              ...
              <ul>
                <li>
                  ...
                  third parties to use tracking technology on the Services, which will enable them
                  to collect data about how you interact with the Services over time. This
                  information may be used to, among other things, analyze and track data, determine
                  the popularity of certain content and better understand online activity. Unless
                  described in this Policy, we do not share, sell, rent or trade any of your
                ...
                <li>
                  ...
                  when you visit the Services. These companies may use information about your visits
                  to our Website(s) and other websites that are contained in web cookies and other
                  tracking technologies in order to provide advertisements about goods and services
                  of interest to you.
                </li>
                <li>
            ...
            <li>
              ...
              in this policy will require us keeping your personal information for longer than 2
              years past the termination of the user's account.
              <br />
              <br />
            ...
            <li>
              ...
              >
                <u>http://ec.europa.eu/justice/data-protection/bodies/authorities/index_en.htm</u>
              </a>
              .
              <br />
              <br />
              ...
              <br />
              <br />
              <i>Cookies and similar technologies</i>
              ...
              <br />
              <br />
              <i>Opting out of email marketing</i>
              ...
              will still need to send you service-related emails that are necessary for the
              administration and use of your account. To otherwise opt-out, you may:
              <br />
              <ul>
                <li>Update preferences using the Unsubscribe link in a previous email.</li>
              </ul>
            </li>
            <li>
            ...
            <li>
              ...
              team@symply.io or by post to:
              <br />
              <br />
              <span style={{ paddingLeft: '30px' }}>
                <b>Symply Software Inc.</b>
              </span>
              <br />
              <span style={{ color: '#211E5E', marginLeft: '30px' }}>10251 Trademark St Ste B</span>
              <br />
              <span style={{ color: '#211E5E', marginLeft: '30px' }}>
                Rancho Cucamonga, CA 91730
              </span>
              <br />
              <span style={{ color: '#211E5E', marginLeft: '30px' }}>United States</span>
              <br />
              <br />
              <span style={{ color: '#211E5E' }}>
                ...
                personal information we collect from you, change that information, or delete it in
                some circumstances. To request to review, update, or delete your personal
                information, please visit: app.symply.io. We will respond to your request within 30
                days.
              </span>
              <br />
              <br />
              ...
              >
                <u>Termly’s Privacy Policy Generator</u>
              </a>
              .
            </li>
          </ol>
